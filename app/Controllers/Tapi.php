...
class Tapi extends BaseController
{
    ...
    private function messageFilter($msg)
    {
        ...
        //TODO tiene que sustituir caracteres, simbolos de puntuacion, y devolver todo en minus
        ...
        $filter1 = str_replace("$str","$rplc", $filter0);
        */
    ...
    private function stelaCommand($message, $command, $chat_id, $message_id)
    {
        ...
        switch ($this->messageFilter($command[1]))
        {
            ...
            case "tiempo":
                ...
                if ($estado)
                {
                    $this->apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "El tiempo actual en ".$command[2].": ".$estado));
                }
                break;
